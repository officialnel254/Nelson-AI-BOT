...
if (antilink === 'TRUE' && antilinkall === 'TRUE' && body.includes('http') && !Owner && isBotAdmin && !isAdmin && m.isGroup) { 
 ...
 client.sendMessage(m.chat, {text:`Removed:\n\n@${ki.split("@")[0]}, sending links is prohibited by Bot Owner!`, contextInfo:{mentionedJid:[ki]}}, {quoted:m}); 
    ...
    if (cmd && !m.isGroup) {
      console.log(chalk.black(chalk.bgWhite("[ Nelson-AI-BOT ]")), color(argsLog, "turquoise"), chalk.magenta("From"), chalk.green(pushname), chalk.yellow(`[ ${m.sender.replace("@s.whatsapp.net", "")} ]`));
...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnail: fs.readFileSync('./Nelson.jpg'),
...
let xf = m.quoted.text;
                ...
                let pppuser = await client.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/f90bc1ca315eed9f1de34.jpg')
                
const rel = await quote(xf, pushname, pppuser)
                
                client.sendImageAsSticker(m.chat, rel.result, m, {
                    packname: pushname,
                    author: `Nelson-AI-BOT`
                })
...
try {
  ...
  let encmediax = await client.sendImageAsSticker(m.chat, mediax, m, { packname: officialnel254, author: officialnel254 });
...
client.sendMessage(from, buttonMessage, { quoted: m }) 
 ...
 break 
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `Converted by Nelson-AI-BOT! 🦄`}, { quoted: m }) 
...
case "movie": 
 ...
 client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/f90bc1ca315eed9f1de34.jpg' }, caption: `You can deploy this bot using the github link below!\nFork and give us a star ✨.\n\nhttps://github.com/officialnel254/Nelson-AI-BOT\n\nYou can link Nelson-AI-BOT without scanning qr using replit in the link below:\n\nhttps://replit.com/@Nelsonmwaniki/Pairing-Nelson-AI-BOT?s=app\n\nFor deployment using heroku, fork the repo and use this link whilst replacing your-user-name and fork-name with actual details\nhttps://heroku.com/deploy?template=https://github.com/your-user-name/fork-name\n\nAre you having difficulties deploying this bot? Contact us for help!\n\nMade on Earth by officialnel254!` }, {quoted: m}); 
 ...
 break; 
    ...
    break;
         ...
         for (let i of res) { 
             let txt = `</ Nelson-AI-BOT Broadcast >\n\n🀄 Message: ${text}\n\nAuthor: ${pushname}` 
             await client.sendMessage(i, { 
                 image: { 
                     url: "https://telegra.ph/file/f90bc1ca315eed9f1de34.jpg" 
                 }, 
                 caption: `${txt}` 
             }) 
         } 
...
case "getvar": 
 if (!Owner) throw NotOwner;  
     ...
     let stoy = '*Below Are Heroku Variables For Nelson-AI-BOT:*\n\n';  
        ...
        default: {
          if (cmd && budy.toLowerCase() != undefined) {
            ...
            if (argsLog || (cmd && !m.isGroup)) {
              ...
              console.log(chalk.black(chalk.bgRed("[ ERROR ]")), color("command", "turquoise"), color(`${prefix}${command}`, "turquoise"), color("Nelson-AI-BOT", "turquoise"));
